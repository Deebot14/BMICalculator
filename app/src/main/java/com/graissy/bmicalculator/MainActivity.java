package com.graissy.bmicalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private double calculateBmi() {
        ...
        // BMI formula is the weight in kg devided by height in meters squared
    ...
    private void displayResult(double bmi){
        ...
        if(bmi < 18.5){
            ...
            fullResultString = bmiTextResult + " - You have a healthy weight";
        }
